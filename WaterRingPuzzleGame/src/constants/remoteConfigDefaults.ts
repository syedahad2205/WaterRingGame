...
export const REMOTE_CONFIG_DEFAULT_SALT_GLOBAL: string = 'water-ring-v1-global';

/** Shared HMAC salt used for daily-challenge coin-event signing */
export const REMOTE_CONFIG_DEFAULT_SALT_DAILY: string = 'water-ring-v1-daily';

/** Coin cost for a single continue during a challenge */
export const REMOTE_CONFIG_DEFAULT_BASE_CONTINUE_COST: number = 50;
 ...
 */
export const REMOTE_CONFIG_DEFAULT_BASE_WATER_FORCE: number = 0.003;

/** Maximum number of rewarded-ad views a player may watch per calendar day */
export const REMOTE_CONFIG_DEFAULT_MAX_DAILY_AD_VIEWS: number = 5;
 ...
 */
export const REMOTE_CONFIG_DEFAULT_QUALITY_SCORE_THRESHOLD: number = 0.65;

/**
 * Bonus seconds added to the timer when a near-miss is detected
 * by the AdaptiveAssistController.
 */
export const REMOTE_CONFIG_DEFAULT_NEAR_MISS_BONUS_SECONDS: number = 3;

/** Maximum number of bubble particles that may be active simultaneously in the arena */
export const REMOTE_CONFIG_DEFAULT_MAX_ACTIVE_BUBBLES: number = 40;

/** Maximum number of ripple effects that may be active simultaneously in the arena */
export const REMOTE_CONFIG_DEFAULT_MAX_ACTIVE_RIPPLES: number = 20;
